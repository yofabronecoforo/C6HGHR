...
VALUES 
    ('GOODYHUT_HOSTILES', 3, 'LOC_EGHS_GOODYHUT_HOSTILES_NAME', 'LOC_EGHS_GOODYHUT_HOSTILES_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN');
...
VALUES 
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_MELEE_1', 2, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_1_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_1_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 55, 55), 
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_MELEE_2', 2, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_2_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_2_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 30, 30), 
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_MELEE_3', 2, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_3_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_3_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 15, 15); 
