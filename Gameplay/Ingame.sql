...
VALUES
    ...
    ('GOODYHUT_HOSTILE_MELEE', 'KIND_GOODY_HUT');
...
VALUES
    ('GOODYHUT_HOSTILE_MELEE', 'GOODYHUT_HOSTILE_MELEE_1', 'LOC_GOODYHUT_HOSTILE_MELEE_1_DESCRIPTION', 55, 2, 0, 1, 'GOODY_HGHR_DUMMY_REWARD'),
    ('GOODYHUT_HOSTILE_MELEE', 'GOODYHUT_HOSTILE_MELEE_2', 'LOC_GOODYHUT_HOSTILE_MELEE_2_DESCRIPTION', 30, 2, 0, 1, 'GOODY_HGHR_DUMMY_REWARD'),
    ('GOODYHUT_HOSTILE_MELEE', 'GOODYHUT_HOSTILE_MELEE_3', 'LOC_GOODYHUT_HOSTILE_MELEE_3_DESCRIPTION', 15, 2, 0, 1, 'GOODY_HGHR_DUMMY_REWARD');
