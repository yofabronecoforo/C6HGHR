...
REPLACE INTO TribalVillageTypes 
    (GoodyHut, NumRewards, Name, Description, Icon)
VALUES 
...
REPLACE INTO TribalVillageRewards 
    (GoodyHut, SubTypeGoodyHut, Turn, MinOneCity, RequiresUnit, Name, Description, Icon, IconFG, Weight, DefaultWeight)
VALUES 
    ...
    -- ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_RECON_CAMP', 0, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_RECON_CAMP_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_RECON_CAMP_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 5, 5), 
    ...
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_MELEE_CAMP', 0, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_CAMP_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_MELEE_CAMP_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 5, 5), 
    ...
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_RANGED_CAMP', 0, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_RANGED_CAMP_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_RANGED_CAMP_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 5, 5), 
    ...
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_ANTI_CAVALRY_CAMP', 2, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_ANTI_CAVALRY_CAMP_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_ANTI_CAVALRY_CAMP_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 5, 5), 
    ...
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_HEAVY_CAVALRY_CAMP', 30, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_HEAVY_CAVALRY_CAMP_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_HEAVY_CAVALRY_CAMP_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 5, 5), 
    ...
    ('GOODYHUT_HOSTILES', 'GOODYHUT_HOSTILE_LIGHT_CAVALRY_CAMP', 60, 0, 1, 'LOC_EGHS_GOODYHUT_HOSTILE_LIGHT_CAVALRY_CAMP_NAME', 'LOC_EGHS_GOODYHUT_HOSTILE_LIGHT_CAVALRY_CAMP_DESCRIPTION', 'ICON_CIVILIZATION_BARBARIAN', NULL, 5, 5);
