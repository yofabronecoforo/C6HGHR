...
VALUES 
    ...
    ('ERA_FUTURE', 'PROMOTION_CLASS_NAVAL_MELEE', 'UNIT_DESTROYER'), 
    ('ERA_FUTURE', 'PROMOTION_CLASS_RANGED', 'UNIT_MACHINE_GUN'), 
    ('ERA_FUTURE', 'PROMOTION_CLASS_NAVAL_RANGED', 'UNIT_MISSILE_CRUISER'), 
    ('ERA_FUTURE', 'PROMOTION_CLASS_ANTI_CAVALRY', 'UNIT_MODERN_AT'), 
    ('ERA_FUTURE', 'PROMOTION_CLASS_HEAVY_CAVALRY', 'UNIT_MODERN_ARMOR'), 
    ('ERA_FUTURE', 'PROMOTION_CLASS_SUPPORT', 'UNIT_SUPPLY_CONVOY'), 
    ('ERA_FUTURE', 'PROMOTION_CLASS_SIEGE', 'UNIT_ROCKET_ARTILLERY'), 
